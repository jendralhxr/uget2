...
def plot_1d(csv_path: str, x_key: str, y_key: str, winsize:int = 300, save_path: str = None, show_result: bool = True):
    """
    ...
    :param winsize: Size of the moving window for smoothing the data. Default is 300.
    :param save_path: Optional path to save the plot as an image. If None, the plot will not be saved.
    :param show_result: Whether or not to display the plot on the screen. Default is True.
